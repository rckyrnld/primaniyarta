                                ...
                                <div class="row py-2">
                                    <form id="frmprof" name="frmprof" method="post" action="<?php echo base_url('main/simpanprofil'); ?>">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control rounded-0" id="npwp" name="npwp" maxlength="15" value="<?php echo $vnpwp; ?>" readonly required>
                                            </div>
                                            <?php 
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                if($n > 0) {
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="idmodal" id="idmodal<?php echo $i; ?>" value="<?php echo $d[$i]->idmodal; ?>" <?php if($d[$i]->idmodal==$vidmo) { echo "checked"; } ?>>
                                            ...
                                            <div class="col-md-6">
                                               ...
                                               $n = $ju->num_rows();
                                                if($n > 0) {
                                                    ...
                                                    ?>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="idjenis" id="idjenis<?php echo $i; ?>" value="<?php echo $d[$i]->idjenis; ?>" <?php if($d[$i]->idjenis==$vidju) { echo "checked"; } ?>>
