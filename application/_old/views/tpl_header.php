        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <ul class="navbar-nav">
                <!--<li class="nav-item <?php //if($menu=="home") echo 'active'; ?>">
                    <a class="nav-link" href="<?php //echo base_url('web/daftar'); ?>">Beranda</a>
                </li>
                <li class="nav-item dropdown <?php //if($menu=="tentang") echo 'active'; ?>">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbartentang">
                        <a class="dropdown-item" href="#">Tentang Primaniyarta</a>
                        <a class="dropdown-item" href="#">Kategori Primaniyarta</a>
                        <a class="dropdown-item" href="#">Keuntungan Meraih Penghargaan</a>
                    </div>
                </li>
                ...
                if(!empty($this->session->sessemail)) {
                    ...
                    <li class="nav-item <?php if($menu=="daftar") echo 'active'; ?>">
                        <a class="btn btn-success mx-2 rounded-0" href="<?php echo base_url('akun'); ?>">Halaman Form Primaniyarta</a>
                    </li>
                    <li class="nav-item <?php if($menu=="login") echo 'active'; ?>">
                        <a class="btn btn-primary rounded-0" href="<?php echo base_url('web/logout'); ?>">Logout</a>
                    </li>
                    <?php
                }
                else {
