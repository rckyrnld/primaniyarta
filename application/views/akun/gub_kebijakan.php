                    ...
                    <div class="card rounded-0">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                ?>
                                <div class="row py-2">
                                    <form id="frmkebijakan" name="frmkebijakan" method="post" action="<?php echo base_url('main/simpankebijakangub'); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <label class="form-text">Format dokumen .pdf dengan maksimal ukuran file 2 MB</label>
                                            </div>
                                            <?php 
                                            if($vfile!="") {
                                                ?>
                                            ...
                                            if($n > 0) {
                                                for ($i = 0; $i < count($d); ++$i) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('main/kebijakan/'.$this->secure->encrypt_url($d[$i]->idkebijakan)); ?>" style="text-decoration: none; color: green;">Edit</a> | 
                                                            <a href="<?php echo base_url('main/hapuskebijakan/'.$this->secure->encrypt_url($d[$i]->idkebijakan)); ?>" style="text-decoration: none; color: red;">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
