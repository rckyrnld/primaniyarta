                                            ...
                                            <div class="row py-2">
                                                ...
                                                <input type="hidden" id="idprofil" name="idprofil" value="<?php echo $idprofil; ?>">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control rounded-0" id="persen_ekspor" name="persen_ekspor" maxlength="5" value="<?php echo $vpersenekspor; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control rounded-0" id="persen_lokal" name="persen_lokal" maxlength="5" value="<?php echo $vpersenlokal; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                            ...
                                            <div class="row py-2">
                                                <form id="frmekspor" name="frmekspor" method="post" action="<?php echo base_url('main/simpanekspor'); ?>">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control rounded-0" id="rasio_2019" name="rasio_2019" maxlength="5" value="<?php echo $vrasio2019; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="rasio_2020" class="col-md-3 mb-2">Rasio Ekspor 2020 (%)</label>
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control rounded-0" id="rasio_2020" name="rasio_2020" maxlength="5" value="<?php echo $vrasio2020; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <label for="rasio_2021" class="col-md-3 mb-2">Rasio Ekspor 2021 (%)</label>
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control rounded-0" id="rasio_2021" name="rasio_2021" maxlength="5" value="<?php echo $vrasio2021; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group py-2">
                                                        <div class="row">
...
<script>
    $('#persen_ekspor').on('change', function() {
        ...
        document.getElementById("nilai_ekspor").value = xnilai_ekspor.toFixed(2); 
        ...
        document.getElementById("persen_lokal").value = xpersen_lokal.toFixed(2); 
        document.getElementById("nilai_lokal").value = xnilai_lokal.toFixed(2);   
   });
