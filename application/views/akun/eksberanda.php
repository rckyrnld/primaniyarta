                                ...
                                <div class="row">
                                    ...
                                    if($ck==FALSE) {
                                        ...
                                        if($c==FALSE) {
                                            ...
                                            <p>Untuk memulai pendaftaran harap pilih salah satu dari pilihan dibawah ini</p>
                                            <p>Saya mendaftar mengikuti Penghargaan Primaniyarta sebagai</p>
                                            <div class="row mb-2">
                                                <div class="col-lg-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p class="text-center"><a href="<?php echo base_url('main/tambahprofil'); ?>" style="text-decoration: none; color: #1f1f1f;"><b>Eksportir</b></a></p>
                                                            <a href="<?php echo base_url('main/tambahprofil'); ?>"><img class="img-fluid mx-auto d-block rounded-0 py-2" src="<?php echo base_url('assets/images/undraw_factory_dy-0-a-156.png'); ?>"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p class="text-center"><a href="<?php echo base_url('main/kepaladaerah'); ?>" style="text-decoration: none; color: #1f1f1f;"><b>Kepala Daerah</b></a></p>
                                                            <a href="<?php echo base_url('main/kepaladaerah'); ?>"><img class="img-fluid mx-auto d-block rounded-0 py-2" src="<?php echo base_url('assets/images/undraw_memory_storage_reh0-156.png'); ?>"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    /*if($this->decrypt_profilid==0) {
                                        ?>
                                        <p>Untuk pendaftaran Primaniyarta kategori <b>Kepala Daerah Pendukung Ekspor</b> daftar <a href="<?php echo base_url('main/kepaladaerah'); ?>">disini</a></p>
                                        <?php
                                    }*/
                                    ?>
