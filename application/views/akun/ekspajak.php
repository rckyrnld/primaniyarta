                                ...
                                <div class="row py-2">
                                    ...
                                    <input type="hidden" id="idprofil" name="idprofil" value="<?php echo $idprofil; ?>">
                                        ...
                                        <div class="row mb-2 py-2">
                                            <label for="jabatan" class="col-md-3 mb-2">PPN Jan-Des</label>
                                            <div class="col-md-9">
                                                <div class="form-check form-check-inline">
                                        ...
                                        <div class="row mb-2">
                                            <label for="jenis" class="col-md-3 mb-2">Setoran PPN Jan-Des</label>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" colspan="2">PPN Jan-Des (Rp)</th>
