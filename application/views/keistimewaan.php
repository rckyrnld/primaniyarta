    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card rounded-0">
                <div class="card-header">KEISTIMEWAAN PENGHARGAAN PRIMANIYARTA</div>
                <div class="card-body">
                    <div class="card-body">
                        <div class="card mb-3 border-0">
                            <div class="row g-0">
                                ...
                                <div class="col-lg-10">
                                    <div class="card-body">
                                        <p class="card-title px-2 py-2" style="font-size: 18px;"><b>BRANDING PENERIMA</b></p>
                                        <p class="card-text px-2" style="font-size: 15px;">Berhak mencantumkan foto piala di kemasan atau produknya</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        Akan dipromosikan oleh Kemendag dan seluruh perwakilan</p>
                        ...
                        <div class="card mb-3 border-0">
                            <div class="row g-0">
                                ...
                                <div class="col-lg-10">
                                    <div class="card-body">
                                        <p class="card-title" style="font-size: 18px;"><b>KEIKUTSERTAAN PROGRAM  DITJEN PENGEMBANGAN EKSPOR NASIONAL</b></p>
